...
var author$project$Main$GetSavedCodes = function (a) {
	return {$: 'GetSavedCodes', a: a};
};
var author$project$Main$Model = F5(
	function (savedCodes, currentCode, name, savedText, currentText) {
		return {currentCode: currentCode, currentText: currentText, name: name, savedCodes: savedCodes, savedText: savedText};
	});
var author$project$Main$Code = F2(
...
var author$project$Main$codeDecoder = elm$json$Json$Decode$array(
	A3(
...
var author$project$Main$getCodes = A2(elm$http$Http$get, 'http://localhost:3000/codes', author$project$Main$codeDecoder);
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A5(
			...
			'',
			''),
		A2(elm$http$Http$send, author$project$Main$GetSavedCodes, author$project$Main$getCodes));
};
...
var author$project$Main$setCurrentCode = F2(
	function (newCode, model) {
		return _Utils_update(
			model,
			{currentCode: newCode});
	});
var author$project$Main$asCurrentCodeIn = author$project$Main$flip(author$project$Main$setCurrentCode);
var author$project$Main$setCodeLines = F2(
	function (newLines, code) {
		return _Utils_update(
			code,
			{lines: newLines});
	});
var author$project$Main$setCodeName = F2(
		...
		switch (msg.$) {
			...
			case 'Input':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{currentText: text, savedText: text}),
			...
			case 'Add':
				var newModel = A2(
					author$project$Main$asCurrentCodeIn,
					model,
					A2(
						author$project$Main$setCodeLines,
						A2(elm$core$String$split, '\n', model.currentText),
						A2(author$project$Main$setCodeName, model.name, model.currentCode)));
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
...
var author$project$Main$inputElem = function (m) {
	return A2(
		elm$html$Html$input,
		_List_fromArray(
			[
...
var author$project$Main$showCode = F2(
	function (idx, code) {
		return A2(
			elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$text(code.codename)
						])),
					A2(
					elm$html$Html$li,
					_List_Nil,
...
var author$project$Main$showCodes = function (codes) {
	return A2(
		elm$html$Html$ul,
		_List_Nil,
		elm$core$Array$toList(
			A2(elm$core$Array$indexedMap, author$project$Main$showCode, codes)));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$value(model.currentText),
						elm$html$Html$Attributes$class('text-editor')
					]),
				_List_Nil),
				author$project$Main$inputElem(model),
				A2(
				...
				author$project$Main$showCodes(model.savedCodes)
			]));
};
