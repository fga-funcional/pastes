...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{codes: _List_Nil, currentText: '', savedText: ''},
...
var author$project$Main$codesDecoder = elm$json$Json$Decode$list(elm$json$Json$Decode$string);
...
var author$project$Main$httpCommand = A2(
	...
	A2(elm$http$Http$get, 'http://localhost:3000/codes', author$project$Main$codesDecoder));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$renderList(model.codes),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
